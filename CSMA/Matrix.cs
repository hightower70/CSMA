...
namespace CSMA
{
	public class Matrix
	{
		...
		/// <summary>
		/// Construct a matrix without error checking from 2D array
		/// </summary>
		/// <param name="A">2D array of doubles</param>
		/// <param name="m">Number of rows</param>
		/// <param name="n">Number of columns</param>
		public Matrix(double[,] A, int m, int n)
		{
		...
		/// <summary>
		/// Construct a matrix from a copy of a 2D array
		/// </summary>
		/// <param name="A">2D  array of dobules</param>
		/// <returns>Matrix with values copied from A</returns>
		public static Matrix constructWithCopy(double[,] A)
		{
			int m = A.GetLength(0);
		...
		/// <summary>
		/// Access the internal 2D array
		/// </summary>
		/// <returns>2D array of matrix elements</returns>
		...
		public static bool operator ==(Matrix A, Matrix B)
		{
			...
			if (A.rowDimension != B.rowDimension|| A.colDimension != B.colDimension)
				return false;

			for (int i = 1; i <= A.rowDimension; i++)
			{
				for (int j = 1; j <= A.colDimension; j++)
				{
		...
		public override bool Equals(object obj)
		{
			...
			if (this.rowDimension != O.rowDimension || this.colDimension != O.colDimension)
				return false;
		...
		public override string ToString()
		{
			...
			for (int i = 0; i < rowDimension; i++)
			{
				for (int j = 0; j < colDimension; j++)
					s.Append(String.Format("{0,5:0.00}", A[i, j]) + " ");
